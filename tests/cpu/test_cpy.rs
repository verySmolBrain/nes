...
mod test {
    ...
    fn test_c0_immediate_a_greater() {
        ...
        check(&mut cpu, expect![[r#"
            0000  C0 05     CPY #$05                        A:00 X:00 Y:06 P:24 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:00 Y:06 P:25 SP:FD PPU:  0,  6 CYC:2"#]])
    }
    ...
    fn test_c0_immediate_a_less() {
        ...
        check(&mut cpu, expect![[r#"
            0000  C0 06     CPY #$06                        A:00 X:00 Y:05 P:24 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:00 Y:05 P:A4 SP:FD PPU:  0,  6 CYC:2"#]])
    }
    ...
    fn test_c0_immediate_zero_zero() {
        ...
        check(&mut cpu, expect![[r#"
            0000  C0 00     CPY #$00                        A:00 X:00 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
    ...
    fn test_c0_immediate_test_big() {
        ...
        check(&mut cpu, expect![[r#"
            0000  C0 FF     CPY #$FF                        A:00 X:00 Y:01 P:24 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:00 Y:01 P:24 SP:FD PPU:  0,  6 CYC:2"#]])
    }
}