...
mod test {
    ...
    fn test_0x10_bpl_relative_no_branch() {
        ...
        check(&mut cpu, expect![[r#"
            0000  10 05     BPL $07                         A:00 X:00 Y:00 P:A4 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:00 Y:00 P:A4 SP:FD PPU:  0,  6 CYC:2"#]])
    }
    ...
    fn test_0x10_bpl_relative_branch() {
        ...
        check(&mut cpu, expect![[r#"
            0000  10 05     BPL $07                         A:00 X:00 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
