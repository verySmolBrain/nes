...
mod test {
    ...
    fn test_0xb0_bcs_relative_no_branch() {
        ...
        check(&mut cpu, expect![[r#"
            0000  B0 05     BCS $07                         A:00 X:00 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
    ...
    fn test_0xb0_bcs_relative_branch() {
        ...
        check(&mut cpu, expect![[r#"
            0000  B0 05     BCS $07                         A:00 X:00 Y:00 P:25 SP:FD PPU:  0,  0 CYC:0
            0007  00        BRK                             A:00 X:00 Y:00 P:25 SP:FD PPU:  0,  9 CYC:3"#]])
    }
}