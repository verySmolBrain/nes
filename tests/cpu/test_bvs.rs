...
mod test {
    ...
    fn test_0x70_bvs_relative_no_branch() {
        ...
        check(&mut cpu, expect![[r#"
            0000  70 05     BVS $07                         A:00 X:00 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
    ...
    fn test_0x70_bvs_relative_branch() {
        ...
        check(&mut cpu, expect![[r#"
            0000  70 05     BVS $07                         A:00 X:00 Y:00 P:64 SP:FD PPU:  0,  0 CYC:0
            0007  00        BRK                             A:00 X:00 Y:00 P:64 SP:FD PPU:  0,  9 CYC:3"#]])
    }
}