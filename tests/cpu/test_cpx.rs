...
mod test {
    ...
    fn test_e0_immediate_a_greater() {
        ...
        check(&mut cpu, expect![[r#"
            0000  E0 05     CPX #$05                        A:00 X:06 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:06 Y:00 P:25 SP:FD PPU:  0,  6 CYC:2"#]])
    }
    ...
    fn test_e0_immediate_a_less() {
        ...
        check(&mut cpu, expect![[r#"
            0000  E0 06     CPX #$06                        A:00 X:05 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:05 Y:00 P:A4 SP:FD PPU:  0,  6 CYC:2"#]])
    }
    ...
    fn test_e0_immediate_zero_zero() {
        ...
        check(&mut cpu, expect![[r#"
            0000  E0 00     CPX #$00                        A:00 X:00 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
    ...
    fn test_e0_immediate_test_big() {
        ...
        check(&mut cpu, expect![[r#"
            0000  E0 FF     CPX #$FF                        A:00 X:01 Y:00 P:24 SP:FD PPU:  0,  0 CYC:0
            0002  00        BRK                             A:00 X:01 Y:00 P:24 SP:FD PPU:  0,  6 CYC:2"#]])
    }
}