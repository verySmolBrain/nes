use crate::cpu::AddressingMode:: { 
    ...
    ZeroPage, ZeroPage_X, ZeroPage_Y, Relative, Accumulator, Implied, JMPIndirect, Jump };
use crate::cpu::AddressingMode;
use phf::phf_map;
...
pub static OPCODES: phf::Map<u8, OPCode> = phf_map! {
    ...
    0x6d_u8 => OPCode { name: "ADC", bytes: 3, cycles: 4, mode: Absolute },
    0x7d_u8 => OPCode { name: "ADC", bytes: 3, cycles: 4, mode: Absolute_X },
    ...
    0xed_u8 => OPCode { name: "SBC", bytes: 3, cycles: 4, mode: Absolute },
    0xfd_u8 => OPCode { name: "SBC", bytes: 3, cycles: 4, mode: Absolute_X },
    0xf9_u8 => OPCode { name: "SBC", bytes: 3, cycles: 4, mode: Absolute_Y },
    0xe1_u8 => OPCode { name: "SBC", bytes: 2, cycles: 6, mode: Indirect_X },
    ...
    */
    ...
    0x4c_u8 => OPCode { name: "JMP", bytes: 3, cycles: 3, mode: Jump },
    ...
    0x20_u8 => OPCode { name: "JSR", bytes: 3, cycles: 6, mode: Jump },
